 ...
 * Autor Yulia Chyzh
 * 
 * Проектується програмне забезпечення для зберігання інформації про програму підготовки фахівців у ВНЗ з різних спеціальностей.
 * Для кожної спеціальності в базі даних зберігається наступна інформація: шифр спеціальності; назва спеціальності; факультет;
 * перелік навчальних дисциплін. Для кожної навчальної дисципліни вказується час її вивчення (номер курсу і номер семестру),
 * кількість годин, кількість кредитів,  кількість лекційних, практичних або лабораторних робіт,  кількість годин на самостійну роботу студента,
 * види контролю, кафедра. Одна і та ж дисципліна може вивчатися на різних спеціальностях; при цьому час вивчення, кількість годин і види контролю
 * можуть бути різними. З однієї дисципліни може бути кілька видів контролю (наприклад, іспит і курсова робота). Кожна дисципліна викладається
 * тільки однієї кафедрою.
 */
